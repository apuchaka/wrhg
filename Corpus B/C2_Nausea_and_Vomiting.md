...
> **Unintentional weight loss with anorexia or early satiety in an adult over 50** requires a structured search for malignancy and for chronic disease, not reassurance. Cross-refer `TODO:link — I5 Weight, lipids & fluid balance (unbuilt)` and [[B6_Oedema__Fatigue__Weakness_and_Undifferentiated_Presentations]] 0.5.
