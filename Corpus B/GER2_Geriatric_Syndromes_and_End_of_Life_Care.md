...
> Ask **what the patient understands** before telling them anything, ask **what they want to know**, warn before delivering bad news, allow silence, and check understanding afterwards. Cross-refer `TODO:link — GER5 Communication & consultation skills (unbuilt; was COM1 in build queue v1)`.
...
> Delirium in full → [[D2_Altered_Consciousness_and_Cognition]] 0.2 · Dementia and its trajectory → [[D2_Altered_Consciousness_and_Cognition]] 0.3 · Comprehensive geriatric assessment, frailty, falls and deprescribing → [[GER1_Comprehensive_Geriatric_Assessment]] · Constipation, faecal impaction and overflow → [[C5_Bowel_Habit__Obstruction_and_Distension]] 0.2 · Faecal incontinence and pelvic floor → [[C5_Bowel_Habit__Obstruction_and_Distension]] 0.6 · Dysphagia and swallow assessment → [[D7_Cranial_Nerves_and_Special_Senses]] 0.4 · Refeeding syndrome → [[C2_Nausea_and_Vomiting]] 0.7 · Antiemetic selection by mechanism → [[C2_Nausea_and_Vomiting]] 0.5 · Capacity, consent, substitute decision-making and death certification → [[A10_Ethics__Capacity__Consent_and_Certification]] 0.1–0.4 · Elder abuse → `TODO:link — GER4 Safeguarding & forensic (unbuilt; was P3 in build queue v1)` · Oncological and palliative symptom control → `TODO:link — J5 Oncology & palliative (unbuilt)` · Communication skills → `TODO:link — GER5 Communication & consultation skills (unbuilt; was COM1 in build queue v1)` · Cultural safety at end of life → `TODO:link — AU1 Australian health context (unbuilt)` · Peripheral arterial disease and wound healing → [[B5_Murmurs__Endocarditis_and_Vascular_Disease]] 0.5
