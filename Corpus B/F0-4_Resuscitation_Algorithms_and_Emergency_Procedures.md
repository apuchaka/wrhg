...
> Recognition of the seriously unwell child, not the arrest algorithm, is where paediatric lives are saved. Cross-refer `TODO:link — M1 The seriously unwell child (unbuilt)` The Seriously Unwell Child and [[F0-3_Shock_Phenotypes_and_Sepsis_Syndromes]] 0.8 Paediatric Sepsis.
...
Document the block, agent, volume and time in the notes and on the anaesthetic record, since duration affects the peri-operative plan. Cross-refer `TODO:link — L5 Regional limb pain (unbuilt)` Hip Pain and [[11_08a_Ortho_-_Joint_Replacements]].
