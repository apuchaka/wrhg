...
Post-transplant immunosuppression and follow-up. **Mental health assessment where the cause was deliberate self-poisoning** — cross-refer `TODO:link — N1 Risk assessment & suicidality (unbuilt)` and [[A5_Toxicology_II_-_Poisoned_Patient__ADRs_and_Immunotherapy]] 0.1.
...
> Right upper quadrant pain and biliary disease → [[C1_Acute_Abdomen]] 0.3 · Ascending cholangitis → [[F0-3_Shock_Phenotypes_and_Sepsis_Syndromes]] 0.11 · Paracetamol overdose → [[F0-1_Toxidromes__Allergic_Emergencies_and_Envenomation]] 0.6 · GI bleeding and varices → [[C4_Gastrointestinal_Bleeding]] · Pancreatitis → [[C7_Pancreatobiliary_Disease]] · Rebalanced haemostasis and FFP in cirrhosis → [[A9_Transfusion__Coagulopathy_and_Anticoagulant_Emergencies]] 0.3 · Haemolysis → `TODO:link — J2 Haemoglobinopathy & haemolysis (unbuilt)` · Neonatal jaundice → `TODO:link — M3 Neonatal problems (unbuilt)` · Hepatopulmonary syndrome and platypnoea → [[A4_Dyspnoea__Cough_and_the_Solitary_Pulmonary_Nodule]] 0.2 · Alcohol and drug support → `TODO:link — GER3 Preventive & occupational health (unbuilt; was P1 in build queue v1)`
