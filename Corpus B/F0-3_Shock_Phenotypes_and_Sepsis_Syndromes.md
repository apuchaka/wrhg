...
Anticoagulation duration determined by whether the event was provoked or unprovoked. Thrombophilia and malignancy screening in selected patients. Follow-up for chronic thromboembolic pulmonary hypertension in persistently breathless patients. Cross-refer `TODO:link — J3 Bleeding & thrombosis (unbuilt)` Recurrent Thrombosis.
...
Catheter review and removal wherever possible, with a documented plan for those that must stay. Investigation of recurrent UTI. Diabetes optimisation. Cross-refer `TODO:link — H4 Scrotum, groin & loin (unbuilt)` Renal Colic and `TODO:link — H2 LUTS, retention & incontinence (unbuilt)` LUTS.
