...
> [!fail]- CONFLICT CF-039 — Barrett surveillance interval **R3**
...
### 0.3.1 Oesophageal Disease — from unverified layer `CF-039`
`SRC:C6_Dyspepsia__Oesophageal_and_Anorectal_Disease §0.3` `UNVERIFIED — model knowledge, not source-checked.`
*Supersedes the former Barrett's-management fragment; CF-039 is carried.*
...
> **Oesophageal varices** — cross-refer §0.33 Upper GI Bleed.
