...
> [!danger] Added from unverified layer — **BILATERAL** palsy gives a near-normal voice **with stridor**
> `SRC:A2_Airway_Compromise__Stridor_and_Tracheostomy_Emergencies §0.2` `UNVERIFIED — model knowledge, not source-checked.`
> The entry below describes **unilateral** palsy: weak, breathy voice. **Bilateral palsy is the opposite trap — the voice is near-normal, because both cords sit in the midline, and the presentation is STRIDOR.** That is exactly why it is missed: the reassuring voice argues against the airway problem the patient actually has.
> **New stridor after thyroid surgery is bilateral recurrent laryngeal nerve injury until proven otherwise**, and it is an airway emergency, not a voice complaint. See [[13_05b_ENT_-_Stridor__Croup__Epiglottitis__Laryngomalacia__OSA]].
