...
> - **Added from unverified layer — `Stemmer's sign` is the bedside test.** `SRC:B6_Oedema__Fatigue__Weakness_and_Undifferentiated_Presentations §0.3` `UNVERIFIED — model knowledge, not source-checked.` **Inability to pinch and lift a skinfold at the base of the second toe** indicates lymphoedema rather than another cause of swelling. It is positive early, requires nothing, and distinguishes lymphoedema from the pitting oedema of cardiac, renal and hepatic causes at the bedside before any imaging.
