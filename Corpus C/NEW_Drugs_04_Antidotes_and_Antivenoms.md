...
- **Copper (Wilson disease):** **penicillamine** (adverse effects: rash, proteinuria and nephrotic syndrome, marrow suppression, myasthenia-like syndrome, and **paradoxical initial neurological worsening**), **trientine** (better tolerated), and **zinc** (which blocks intestinal copper absorption rather than chelating). See [[NEW_Investigations_General_and_Preventive]] 0.7.
