...
>
> **Meningitis is built in [[D1_Headache_and_Meningism]] 0.5**, **meningococcal sepsis in [[F0-3_Shock_Phenotypes_and_Sepsis_Syndromes]] 0.9**, and **recognition of the seriously unwell child in [[M1_The_Seriously_Unwell_Child]] 0.1** — cross-referenced rather than repeated.
...
> **· END-OF-THE-BED assessment first — appearance, work of breathing, circulation.** Cross-refer [[M1_The_Seriously_Unwell_Child]] 0.1.
...
> **If antibiotics are given before the LP, give them — do not delay treatment — but recognise the CSF culture may be sterilised, which is why PCR matters.** Cross-refer [[D1_Headache_and_Meningism]] 0.5.
...
> **Neonatal HSV has high mortality and severe morbidity, aciclovir is safe, and the diagnosis is easily missed because the vesicles are often not there.** Cross-refer [[O3_Labour__Delivery_and_Postpartum]] and [[O6_Sexual_and_Reproductive_Health]] 0.2.
...
> **Get a properly collected urine sample in any young child with unexplained fever.** Cross-refer [[M5_Paediatric_GI__GU_and_Limb]].
...
> **· OSTEOMYELITIS AND SEPTIC ARTHRITIS — presenting as a limp, refusal to weight bear, or PSEUDOPARALYSIS (an infant not moving a limb).** Cross-refer [[M5_Paediatric_GI__GU_and_Limb]] and [[L1_Hot_and_Swollen_Joint]] 0.2.
> **· Otitis media, tonsillitis, sinusitis, mastoiditis, cellulitis, dental abscess.**
> **· Appendicitis** — cross-refer [[M5_Paediatric_GI__GU_and_Limb]].
...
> **DO NOT DELAY ANTIBIOTICS FOR THE LUMBAR PUNCTURE OR FOR IMAGING.** Cross-refer [[D1_Headache_and_Meningism]] 0.5.
...
> **The examination that distinguishes them: EYE MOVEMENTS, VISUAL ACUITY and the presence of PROPTOSIS** — and they must be assessed, which is difficult in a swollen crying child but is the whole point of the assessment. Cross-refer [[E1_Red_and_Painful_Eye]] and [[F2_Nose_and_Sinus]].

> [!tip] The rest
> **· Pneumonia** — see 0.3.
> **· Osteomyelitis and septic arthritis** — cross-refer [[L1_Hot_and_Swollen_Joint]] 0.2 and [[M5_Paediatric_GI__GU_and_Limb]]. **A child who will not weight bear needs the hip examined and considered for aspiration.**
> **· Retropharyngeal abscess** — a child who will not move their neck, with drooling, a muffled voice and systemic illness. Cross-refer [[F0-5_Acute_Respiratory__Headache_and_Head_Injury]] 0.10.
> **· Epiglottitis** — now rare where Hib vaccination is high, but it still occurs in the under-immunised. **Do not examine the throat or distress the child; get senior airway help.** Cross-refer [[A2_Airway_Compromise__Stridor_and_Tracheostomy_Emergencies]] 0.3.
> **· Sepsis** — cross-refer [[F0-3_Shock_Phenotypes_and_Sepsis_Syndromes]] 0.7.
...
> **GIVE ANTIBIOTICS IMMEDIATELY — do not wait for investigations, transfer or the lumbar puncture.** Cross-refer [[F0-3_Shock_Phenotypes_and_Sepsis_Syndromes]] 0.9.
...
> **· IMMUNE THROMBOCYTOPENIA — petechiae and bruising in a WELL child, often after a viral illness.** Cross-refer [[J1_Cytopenias_and_Marrow_Failure]].
> **· LEUKAEMIA — petechiae with pallor, bruising, bone pain, lymphadenopathy and hepatosplenomegaly.** Cross-refer [[M1_The_Seriously_Unwell_Child]] 0.5 and [[J4_Paraproteins_and_Lymphoproliferative]].
> **· IgA VASCULITIS (Henoch-Schönlein purpura) — PALPABLE PURPURA over the BUTTOCKS and EXTENSOR SURFACES OF THE LEGS, with arthralgia, ABDOMINAL PAIN (which can herald intussusception) and NEPHRITIS.** **Check the urine and blood pressure at diagnosis and on follow-up — the renal involvement is what determines the long-term outcome and it can appear weeks later.** Cross-refer [[L2_Polyarthralgia_and_Inflammatory_Arthritis]] 0.5 and [[H1_Haematuria_and_Proteinuria]].
> **· NON-ACCIDENTAL INJURY.** Cross-refer [[M6_Paediatric_Respiratory_and_Neurology]].
...
> **· SCARLET FEVER — group A streptococcal. A SANDPAPER-textured rash with CIRCUMORAL PALLOR, a STRAWBERRY TONGUE, and later DESQUAMATION.** **Treat with antibiotics — and in Australia this matters particularly because of ACUTE RHEUMATIC FEVER prevention in high-risk populations.** Cross-refer [[F0-5_Acute_Respiratory__Headache_and_Head_Injury]] 0.10 and [[AU1_Australian_Health_Context_and_ATSI_Health]] 0.4.
...
> **· DRUG REACTIONS including SJS/TEN and DRESS** — cross-refer [[A5_Toxicology_II_-_Poisoned_Patient__ADRs_and_Immunotherapy]] 0.6.
...
> **Use the presentation as an opportunity for catch-up**, and check the Australian Immunisation Register. Cross-refer [[GER3_Preventive_and_Occupational_Health]].
...
> **· BRONCHIOLITIS — cross-refer [[M6_Paediatric_Respiratory_and_Neurology]].**
> **· TUBERCULOSIS — in children from or with contacts in high-prevalence areas, and in some remote Australian communities.** Cross-refer [[K3_Exposure__Tuberculosis__HIV_and_Immunodeficiency]] 0.3.
> **· MALARIA in a returning traveller — cross-refer [[K1_Fever_Workup]] 0.4.** **Fever in a child returning from an endemic area is malaria until excluded.**
> **· THE IMMUNOCOMPROMISED CHILD — an oncology patient with fever is FEBRILE NEUTROPENIA until proven otherwise and requires antibiotics within a short defined window, before the workup is complete.** Cross-refer [[K1_Fever_Workup]] 0.5.
...
> Cross-refer [[AU1_Australian_Health_Context_and_ATSI_Health]] 0.4, [[K2_Skin_and_Soft_Tissue_Infection]] 0.6 and [[RESP-X_Occupational_and_Chronic_Lung_Disease]] 0.4.
...
> Recognising the seriously unwell child and red flags → [[M1_The_Seriously_Unwell_Child]] 0.1 · Neonatal problems and jaundice → [[M3_Neonatal_Problems]] · Paediatric GI, urinary and limb presentations → [[M5_Paediatric_GI__GU_and_Limb]] · Paediatric wheeze, bronchiolitis and seizures → [[M6_Paediatric_Respiratory_and_Neurology]] · Child protection → [[M6_Paediatric_Respiratory_and_Neurology]] and [[GER4_Safeguarding_and_Forensic]] · Meningitis and encephalitis → [[D1_Headache_and_Meningism]] 0.5 · Meningococcal sepsis and contact prophylaxis → [[F0-3_Shock_Phenotypes_and_Sepsis_Syndromes]] 0.9 · Sepsis recognition → [[F0-3_Shock_Phenotypes_and_Sepsis_Syndromes]] 0.7 · Febrile neutropenia → [[K1_Fever_Workup]] 0.5 · Tuberculosis → [[K3_Exposure__Tuberculosis__HIV_and_Immunodeficiency]] 0.3 · Malaria and the returning traveller → [[K1_Fever_Workup]] 0.4 · Septic arthritis and osteomyelitis → [[L1_Hot_and_Swollen_Joint]] 0.2 · IgA vasculitis → [[L2_Polyarthralgia_and_Inflammatory_Arthritis]] 0.5 and [[H1_Haematuria_and_Proteinuria]] · Severe cutaneous drug reactions → [[A5_Toxicology_II_-_Poisoned_Patient__ADRs_and_Immunotherapy]] 0.6 · Orbital cellulitis → [[E1_Red_and_Painful_Eye]] and [[F2_Nose_and_Sinus]] · Epiglottitis and croup → [[A2_Airway_Compromise__Stridor_and_Tracheostomy_Emergencies]] 0.3 and [[F0-5_Acute_Respiratory__Headache_and_Head_Injury]] 0.10 · Parvovirus and aplastic crisis → [[J2_Haemoglobinopathy_and_Haemolysis]] · Immunisation and the Australian schedule → [[GER3_Preventive_and_Occupational_Health]] · Aboriginal and Torres Strait Islander child health → [[AU1_Australian_Health_Context_and_ATSI_Health]] 0.4
