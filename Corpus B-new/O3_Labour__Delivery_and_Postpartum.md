...
>
> **Hypertensive disorders, antepartum haemorrhage and CTG are built in [[O2_Later_Pregnancy_and_Fetal]]**, **breastfeeding in [[O7_Breast_Disease]] 0.6**, and **neonatal care in [[M3_Neonatal_Problems]]** — cross-referenced rather than repeated.
...
> **· UTERINE RUPTURE — severe constant pain, cessation of contractions, loss of station, palpable fetal parts, maternal shock and fetal bradycardia, usually in a scarred uterus.** Cross-refer [[O2_Later_Pregnancy_and_Fetal]] 0.3.
> **· AMNIOTIC FLUID EMBOLISM — sudden maternal collapse around the time of delivery, with hypoxia, cardiovascular collapse, seizures and profound DIC.** **Rare, unpredictable, unpreventable, and with high mortality. Management is supportive resuscitation, early massive transfusion and DIC management.** Cross-refer [[A9_Transfusion__Coagulopathy_and_Anticoagulant_Emergencies]] 0.3.
> **· ECLAMPSIA — cross-refer [[O2_Later_Pregnancy_and_Fetal]] 0.2.**
...
> **The long-term consequence of an inadequately managed OASI is FAECAL INCONTINENCE, which may present YEARS later — sometimes after menopause when compensation fails — and which women almost never volunteer.** **Ask directly about flatus and faecal control in any woman with a history of difficult vaginal delivery.** Cross-refer [[O5_Pelvic_and_Vulval_Conditions]] 0.6 and [[C5_Bowel_Habit__Obstruction_and_Distension]] 0.6.
...
> **AND ANTENATAL ANAEMIA — which does not cause the bleed but markedly reduces the woman's ability to tolerate it, and which is why identifying and treating iron deficiency in pregnancy is a haemorrhage intervention.** Cross-refer [[J1_Cytopenias_and_Marrow_Failure]] 0.2.
...
> **· TWO LARGE-BORE CANNULAS · bloods including FBC, coagulation, fibrinogen and CROSSMATCH · and early activation of the MASSIVE TRANSFUSION PROTOCOL if the bleeding is significant.** Cross-refer [[A9_Transfusion__Coagulopathy_and_Anticoagulant_Emergencies]] 0.1.
...
> **ABORIGINAL AND TORRES STRAIT ISLANDER WOMEN experience higher maternal mortality**, reflecting access, chronic disease burden and the broader determinants — and Birthing on Country and community-controlled maternity models improve outcomes. Cross-refer [[AU1_Australian_Health_Context_and_ATSI_Health]] 0.4.
...
> Cross-refer [[O2_Later_Pregnancy_and_Fetal]] 0.1, 0.6 and [[EBM1_Evidence_and_Clinical_Process]] 0.5.
...
> Cross-refer [[O6_Sexual_and_Reproductive_Health]] 0.3.

> [!tip] The newborn
> **The newborn examination and its purpose are in [[M3_Neonatal_Problems]] 0.6 — the items that matter: RED REFLEX (cataract, retinoblastoma) · FEMORAL PULSES (coarctation) · HIPS (developmental dysplasia) · PALATE (looked at AND felt) · testes · and the spine.**
...
> **FEEDING — observe a feed; most nipple pain is an attachment problem; continue breastfeeding through mastitis; and refer early to lactation support rather than after weeks of struggle.** Cross-refer [[O7_Breast_Disease]] 0.6.
> **JAUNDICE — check it, measure it rather than eyeballing it, and remember the timing rules: under 24 hours is always pathological, and beyond two weeks requires a SPLIT bilirubin.** Cross-refer [[M3_Neonatal_Problems]] 0.1.
> **SAFE SLEEPING advice — on the back, own safe sleep space, face uncovered, smoke-free, room-sharing without bed-sharing.** Cross-refer [[M3_Neonatal_Problems]] 0.5.
...
> **RISK FACTORS: previous depression or anxiety · lack of practical and emotional support · FAMILY VIOLENCE (cross-refer [[GER4_Safeguarding_and_Forensic]] 0.4) · a traumatic birth · an unsettled baby or feeding difficulty · socioeconomic adversity · migration and isolation · and a history of pregnancy loss or infertility.**
> **TREATMENT: psychological therapy · practical support · and MEDICATION where indicated, with the framing that matters — the decision is TREATED ILLNESS VERSUS UNTREATED ILLNESS, not medication versus nothing.** **Most antidepressants are compatible with breastfeeding, and untreated maternal depression has its own substantial effects.** Cross-refer [[N4_Mood_Disorders]] 0.6.
> **AND ASK ABOUT SUICIDAL THOUGHTS DIRECTLY.** **Suicide is a leading cause of maternal death, and asking does not plant the idea.** Cross-refer [[N1_Mental_State_Examination_and_Risk]] 0.3.
...
> **Asking about intrusive thoughts gently and normalising them — "lots of new parents get frightening thoughts about something happening to the baby, or even about harming them; it's really common and it doesn't mean anything is wrong with you" — allows disclosure, and the relief is enormous.** Cross-refer [[N5_Anxiety__OCD_and_Trauma]] 0.4.
...
> **What not to say is in [[GER5_Communication_and_Consultation_Skills]] 0.2 — and "at least you can have another one" is the same failure in a different setting.**
...
> Early pregnancy and miscarriage → [[O1_Early_Pregnancy]] · Hypertensive disorders, antepartum haemorrhage, preterm birth and CTG → [[O2_Later_Pregnancy_and_Fetal]] · Contraception and postpartum LARC → [[O6_Sexual_and_Reproductive_Health]] 0.3 · Perineal injury, prolapse and pelvic floor → [[O5_Pelvic_and_Vulval_Conditions]] 0.6 and [[C5_Bowel_Habit__Obstruction_and_Distension]] 0.6 · Breastfeeding, mastitis and lactation support → [[O7_Breast_Disease]] 0.6 · Newborn examination, jaundice, vitamin K and safe sleeping → [[M3_Neonatal_Problems]] · Massive transfusion, tranexamic acid and DIC → [[A9_Transfusion__Coagulopathy_and_Anticoagulant_Emergencies]] 0.1, 0.3 · Sepsis recognition → [[F0-3_Shock_Phenotypes_and_Sepsis_Syndromes]] 0.7 · VTE in pregnancy and the puerperium → [[J3_Bleeding_and_Thrombosis]] 0.4 and [[O2_Later_Pregnancy_and_Fetal]] 0.6 · Peripartum cardiomyopathy and heart failure → [[CV-X_Chronic_Heart_Failure]] · Maternal cardiac arrest and perimortem caesarean → [[F0-4_Resuscitation_Algorithms_and_Emergency_Procedures]] and [[L8_Facial__Head_and_Torso_Trauma]] 0.6 · Epidural complications → [[AN1_Perioperative_Care]] 0.2 · Anaemia in pregnancy → [[J1_Cytopenias_and_Marrow_Failure]] 0.2 · Perinatal depression, medication and suicidality → [[N4_Mood_Disorders]] 0.6 and [[N1_Mental_State_Examination_and_Risk]] 0.3 · Intrusive thoughts and OCD → [[N5_Anxiety__OCD_and_Trauma]] 0.4 · Postpartum psychosis and bipolar disorder → [[N3_Psychosis_and_Antipsychotics]] 0.2 · Birth trauma and PTSD → [[N5_Anxiety__OCD_and_Trauma]] 0.5 · Family violence in the perinatal period → [[GER4_Safeguarding_and_Forensic]] 0.4 · Breaking bad news and bereavement → [[GER5_Communication_and_Consultation_Skills]] 0.2 · Discharge summaries and follow-up ownership → [[EBM1_Evidence_and_Clinical_Process]] 0.5 · Aboriginal and Torres Strait Islander maternal health and Birthing on Country → [[AU1_Australian_Health_Context_and_ATSI_Health]] 0.4
