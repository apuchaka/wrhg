...
Fluid intake advice, dietary modification based on stone composition, treatment of underlying metabolic causes, and follow-up imaging. Cross-refer [[H4_Scrotum__Groin_and_Loin]] Renal Colic.
...
Tonsillectomy assessment for recurrent tonsillitis or recurrent quinsy against defined frequency criteria. **In high-risk populations, follow-up to complete the antibiotic course and consideration of secondary prophylaxis where acute rheumatic fever has occurred.** Cross-refer `TODO:link — 13_ENT, the 13_* ENT series (10 files); the specific file is not determinable from the reference` and [[F4_Neck_Lumps_and_Facial_Pain]] Neck Lumps.

---

> [!note] Cross-references
> Cardiogenic shock, tamponade and massive PE → [[F0-3_Shock_Phenotypes_and_Sepsis_Syndromes]] · Mechanical ventilation, auto-PEEP and NIV detail → [[F0-4_Resuscitation_Algorithms_and_Emergency_Procedures]] 0.7 · Resuscitation algorithms → [[F0-4_Resuscitation_Algorithms_and_Emergency_Procedures]] · Meningococcal sepsis → [[F0-3_Shock_Phenotypes_and_Sepsis_Syndromes]] 0.9 · Headache differentials in full → [[D1_Headache_and_Meningism]] · Renal colic in the urology context → [[H4_Scrotum__Groin_and_Loin]]
